{
  ...
  'targets': [
    ...
    {
      'target_name': 'unicode_adapter_test',
      'product_name': 'UnicodeAdapterTest',
      'type': 'executable',
      'include_dirs' : ['./lib'],
      'defines' : ['GTEST_HAS_RTTI=0', 'UNIT_TEST=1'],
      'sources': [
        './src/utils/os.h',
        './src/utils/os.cc',
        './src/parser/unicode-adapter.h',
        './src/parser/unicode-adapter-inl.h',
        './src/parser/uchar.h',
        './lib/gtest/gtest.h',
        './lib/gtest/gtest-all.cc',
        './test/parser/unicode-adapter-test.cc',
        './test/test-main.cc',
      ],
      'xcode_settings': {
      },
